        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PoritionId = table.Column<int>(type: "int", nullable: false),
                    Deleted = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_Positions_PoritionId",
                        column: x => x.PoritionId,
            ...
            migrationBuilder.CreateIndex(
                name: "idx_FoodCategory_Name",
                table: "FoodCategories",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "idx_FoodCategory_Name_Deleted",
                table: "FoodCategories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_FirstName",
                table: "Teams",
                column: "FirstName");

            migrationBuilder.CreateIndex(
                name: "IX_Teams_FirstName_Deleted",
                table: "Teams",
                columns: new[] { "FirstName", "Deleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Teams_PoritionId",
                table: "Teams",
                column: "PoritionId");
        }
